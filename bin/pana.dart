...
final _parser = new ArgParser()
  ...
  ..addOption('source',
      abbr: 's',
      help: 'The source where the package is located (hosted on http://pub.dartlang.org, or local directory path).',
      allowed: ['hosted', 'path'],
      defaultsTo: 'hosted')
...
void _printHelp({String errorMessage}) {
  ...
  print('''pana [<options>] --source path <absolute directory path>
