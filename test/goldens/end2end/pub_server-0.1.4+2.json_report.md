...
<details>
<summary>
The constraint `^3.0.0` on http_parser does not support the stable version `4.0.0`, that was published 18 days ago. 
...
<details>
<summary>
The constraint `>=0.9.3 <1.0.0` on logging does not support the stable version `1.0.0`, that was published 18 days ago. 
