...
Permission to use/copy, modify    granted.''';
    ...
    final expected = <Token>[
      Token(
          'copyright',
          0,
          SourceSpan(SourceLocation(0, line: 0), SourceLocation(9, line: 0),
              'Copyright')),
      Token(
          'c',
          1,
          SourceSpan(
              SourceLocation(11, line: 0), SourceLocation(13, line: 0), 'C)')),
      Token(
          'permission',
          2,
          SourceSpan(SourceLocation(16, line: 2), SourceLocation(26, line: 2),
              'Permission')),
      Token(
          'to',
          3,
          SourceSpan(
              SourceLocation(27, line: 2), SourceLocation(29, line: 2), 'to')),
      Token(
          'usecopy',
          4,
          SourceSpan(SourceLocation(30, line: 2), SourceLocation(39, line: 2),
              'use/copy,')),
      Token(
          'modify',
          5,
          SourceSpan(SourceLocation(40, line: 2), SourceLocation(46, line: 2),
              'modify')),
      Token(
          'granted',
          6,
          SourceSpan(SourceLocation(50, line: 2), SourceLocation(58, line: 2),
              'granted.')),
    ];
